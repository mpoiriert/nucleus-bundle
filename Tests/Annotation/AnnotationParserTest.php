...
namespace Nucleus\Bundle\CoreBundle\Tests\Annotation;

use Nucleus\Bundle\CoreBundle\Annotation\AnnotationParser;
use Nucleus\Bundle\CoreBundle\Annotation\NoParsingResultException;
...
class AnnotationParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @return \Nucleus\Bundle\CoreBundle\Annotation\IAnnotationParser
     */
    ...
    private function loadAnnotationParserService()
    {
        if (is_null($this->annotationParserService)) {
            ...
            $this->assertInstanceOf('\Nucleus\Bundle\CoreBundle\Annotation\IAnnotationParser', $this->annotationParserService);
        }
    ...
    public function testParseMethod($class, $expectedClassAnnotations, $method, $expectedMethodAnnotations)
    {
        ...
        $this->assertInstanceOf('Nucleus\Bundle\CoreBundle\Annotation\IParsingResult', $result);
