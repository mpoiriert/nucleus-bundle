...
{
    /**
     * @var \Nucleus\Application\IVariableRegistry
     */
    private $applicationVariableRegistry;

    /**
     * @return \Nucleus\Application\IVariableRegistry
     */
    ...
    private function loadApplicationVariableRegistry()
    {
        if (is_null($this->applicationVariableRegistry)) {
            ...
            $this->assertInstanceOf('\Nucleus\Application\IVariableRegistry', $this->applicationVariableRegistry);
        }
