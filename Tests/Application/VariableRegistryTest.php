...
{
    /**
     * @var \Nucleus\Bundle\CoreBundle\Application\IVariableRegistry
     */
    private $applicationVariableRegistry;

    /**
     * @return \Nucleus\Bundle\CoreBundle\Application\IVariableRegistry
     */
    ...
    private function loadApplicationVariableRegistry()
    {
        if (is_null($this->applicationVariableRegistry)) {
            ...
            $this->assertInstanceOf('\Nucleus\Bundle\CoreBundle\Application\IVariableRegistry', $this->applicationVariableRegistry);
        }
